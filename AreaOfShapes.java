...
public class AreaOfShapes {
    ...
    public static double getPositiveNumber(Scanner input) {
        ...
        while (positiveNum <= 0) {
			System.out.print("The number must be positive. Please enter a "
			    + "new number: ");
    ...
    public static double getEllipseArea(double majorRadius, double minorRadius){
    ...
    public static void main(String[] args) {
        ...
        System.out.print("R)ectangle, C)ircle, E)llipse, T)rapezoid, or K)ite: ");
        ...
        switch (shapeType) {
            ...
            case "r":
                ...
                System.out.printf("Area of rectangle is %.3f square units.%n",
                    area);
                break;
            ...
            case "c":
                ...
                System.out.printf("Area of circle is %.3f square units.%n", 
                    circleArea);
                break;
